...
class Category(MPTTModel):
    ...
    template = models.CharField(verbose_name="Шаблон", max_length=500, default="blog/post_category_list.html")
...
class Teg(models.Model):
    ...
    def get_absolute_url(self):
        return reverse("teg_post", kwargs={"slug": self.slug})
...
class Post(models.Model):
    ...
    tags = models.ManyToManyField(Teg, verbose_name='Тег', blank="True", related_name='tags')
